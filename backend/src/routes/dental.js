...
router.post('/procedures/complete', authMiddleware, roleGuard(['DOCTOR', 'ADMIN']), dentalController.completeDentalProcedure);
router.get('/procedures/visit/:visitId', authMiddleware, roleGuard(['DOCTOR', 'ADMIN']), dentalController.getDentalProcedureCompletions);
