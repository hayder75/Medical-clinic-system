    ...
    switch (user?.role) {
      case 'ADMIN':
        return [
          ...
          { name: 'Nurse Performance', href: '/admin/nurse-performance', icon: UserCheck },
      ...
      case 'BILLING_OFFICER':
        return [
          ...
          { name: 'Advance Deposits', href: '/billing/advance-deposits', icon: CreditCard },
          { name: 'Patient Registration', href: '/billing/register', icon: Users },
          { name: 'Patient Management', href: '/billing/patients', icon: Calendar },
          { name: 'Appointments', href: '/billing/appointments', icon: Clock },
