...
import { CreditCard, User, Clock, CheckCircle, AlertTriangle, DollarSign, Search, Trash2, RefreshCw } from 'lucide-react';
...
const BillingQueue = () => {
  ...
  const handlePayment = async (e) => {
    ...
    try {
      // Prepare payment data - use exact billing amount, not form amount
      const paymentData = {
        billingId: selectedBilling.id,
        amount: Number(selectedBilling.totalAmount), // Use exact billing amount
                ...
                <div className="mb-4">
                  ...
                  <div className="space-y-1">
                    {billing.services.map((service, index) => {
                      ...
                      // Format category name (e.g., "DENTAL" -> "Dental")
              ...
              <form onSubmit={handlePayment} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={selectedBilling?.totalAmount || paymentForm.amount}
                    readOnly
                    required
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    Amount is fixed and cannot be changed. Must match the billing total exactly.
                  </p>
                  {formErrors.amount && (
