...
const PatientAccounts = () => {
  ...
  // Removed handleVerify and handleReject - accounts are auto-approved when created by admin
...
const AccountModal = ({ account, type, onClose }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (type === 'create') {
        // Admin creates accounts directly - they are auto-approved
        ...
        // ADVANCE account deposit - admin adds directly
        ...
        // CREDIT account - add more credit limit - admin adds directly
        await api.post('/accounts/deposit', {
          accountId: account.id,
          patientId: account.patientId,
          amount: parseFloat(formData.amount),
