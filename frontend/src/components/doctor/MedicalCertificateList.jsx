    ...
    return `
      ...
      <div class="info-grid">
        ...
        <div class="info-box">
          ...
          <div class="info-row">
            ...
            <span class="info-value">${certificate.doctor.specialties?.join(', ') || 'General Practitioner'}</span>
          </div>
        </div>
      </div>
      ...
      <div class="cert-footer">
        <div class="doctor-sign-box">
          <div class="clinic-stamp">Clinic Stamp</div>
        </div>
        <div class="doctor-sign-box">
          <div class="sign-line"></div>
          <div class="sign-label">Doctor's Signature & Stamp</div>
