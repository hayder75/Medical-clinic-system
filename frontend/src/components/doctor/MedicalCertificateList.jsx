  ...
  const generateCertificateHTML = (certificate) => {
    ...
    return `
      ...
      <div class="text-center py-2 border-b border-gray-300">
        <h1 class="text-2xl font-bold text-black mb-1">Selihom Medical Clinic</h1>
        <p class="text-sm text-black mb-1">Dr. ${certificate.doctor.fullname}</p>
        <p class="text-xs text-black">Phone: ${certificate.doctor.phone || 'N/A'} | Email: ${certificate.doctor.email || 'N/A'}</p>
      </div>
      ...
      <div class="text-center py-2 border-b border-gray-300">
        <div style="display: flex; justify-content: space-between; align-items: center;">
          ...
          <h2 class="text-2xl font-bold text-black uppercase">MEDICAL CERTIFICATE</h2>
          <div style="flex: 1; text-align: right;">
            <p class="text-sm text-black">Certificate No.: ${certificate.certificateNo}</p>
          </div>
        </div>
      </div>
      ...
      <div class="py-2 border-b border-gray-300">
        <h3 class="text-base font-bold text-black underline mb-1">Patient Information</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 8px;">
          <p class="text-sm text-black"><strong>Name:</strong> ${certificate.patient.name}</p>
          <p class="text-sm text-black"><strong>Gender:</strong> ${certificate.patient.gender || 'Not specified'}</p>
          <p class="text-sm text-black"><strong>Age:</strong> ${calculateAge(certificate.patient.dob)} years</p>
        </div>
      </div>

      <!-- Certificate Details -->
      <div class="py-2 border-b border-gray-300">
        <h3 class="text-base font-bold text-black underline mb-1">Certificate Details</h3>
        <p class="text-sm text-black"><strong>Date Issued:</strong> ${formatDate(certificate.certificateDate)}</p>
      </div>

      <!-- Medical Information -->
      <div class="py-2 border-b border-gray-300">
        <h3 class="text-base font-bold text-black underline mb-1">Medical Information</h3>
        <div class="space-y-1">
          <p class="text-sm text-black"><strong>Diagnosis:</strong> ${certificate.diagnosis}</p>
          ${certificate.treatment ? `<p class="text-sm text-black"><strong>Treatment:</strong> ${certificate.treatment}</p>` : ''}
          ${certificate.recommendations ? `<p class="text-sm text-black"><strong>Recommendations:</strong> ${certificate.recommendations}</p>` : ''}
        </div>
      </div>

      <!-- Rest Period -->
      <div class="py-2 border-b border-gray-300">
        <h3 class="text-base font-bold text-black underline text-center mb-1">Rest Period</h3>
      ...
      <!-- Issued By -->
      <div class="py-2">
        <h3 class="text-base font-bold text-black underline mb-1">Issued By</h3>
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 8px;">
          <p class="text-sm text-black"><strong>Name:</strong> ${certificate.doctor.fullname}</p>
          <p class="text-sm text-black"><strong>Specialization:</strong> ${certificate.doctor.specialties?.join(', ') || 'General Doctor'}</p>
        </div>
      </div>
