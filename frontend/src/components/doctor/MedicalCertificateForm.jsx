        ...
        <div className="space-y-2 relative">
          ...
          <div className="relative w-full">
            <input
              ...
              className="w-full px-3 py-2 pl-3 pr-10 border rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2"
              style={{ 
          ...
          {showPatientSearch && (
            <div className="absolute z-50 w-full max-w-full bg-white border rounded-md shadow-lg mt-1 left-0 right-0 overflow-hidden">
