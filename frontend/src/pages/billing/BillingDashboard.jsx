...
const BillingDashboard = () => {
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Billing Queue</h3>
          <p className="text-sm text-gray-600">Process payments and handle pending billings</p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-gray-600">Register new patients or create visits for existing patients</p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-gray-600">Manage patient card status, activation, and billing</p>
        </div>
        ...
        >
          ...
          <p className="text-sm text-gray-600">View all appointments and send patients to doctor queue</p>
        </div>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Pre-Registration</h3>
          <p className="text-sm text-gray-600">Handle phone call registrations and appointments</p>
        </div>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Doctor Queue Management</h3>
          <p className="text-sm text-gray-600">Monitor doctor availability and patient assignments</p>
        </div>
        ...
        >
          ...
          <h3 className="text-lg font-semibold text-gray-900 mb-2">Patient Gallery</h3>
          <p className="text-sm text-gray-600">Upload and manage patient before/after images</p>
        </div>
  ...
  return (
    <Routes>
      ...
      <Route path="/doctor-queue" element={<ReceptionDoctorQueueManagement />} />
